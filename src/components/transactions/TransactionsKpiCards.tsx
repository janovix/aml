...
export function TransactionsKpiCards(): React.ReactElement {
	...
	const kpis = [
		...
		},
		{
			...
			icon: <DollarSign className="h-6 w-6" />,
			trend: { value: 8, label: "vs mes anterior", direction: "up" as const },
			severity: "default" as const,
		},
		{
			title: "Completadas",
			...
			trend: { value: 5, label: "hoy", direction: "up" as const },
		...
		},
		{
			...
			trend: { value: 15, label: "nuevos hoy", direction: "up" as const },
