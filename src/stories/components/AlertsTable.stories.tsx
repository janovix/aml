...
const mockAlerts: Alert[] = [
	{
		...
		metadata: {},
		isManual: false,
		submissionDeadline: new Date("2024-12-07T00:00:00.000Z").toISOString(),
		isOverdue: false,
		createdAt: new Date("2024-11-30T00:00:00.000Z").toISOString(),
		updatedAt: new Date("2024-11-30T00:00:00.000Z").toISOString(),
		alertRule: {
			id: "rule-1",
	...
	},
	{
		...
		metadata: {},
		isManual: false,
		submissionDeadline: new Date("2024-11-29T00:00:00.000Z").toISOString(),
		isOverdue: true,
		submittedAt: new Date("2024-11-30T00:00:00.000Z").toISOString(),
		createdAt: new Date("2024-11-30T00:00:00.000Z").toISOString(),
		updatedAt: new Date("2024-11-30T00:00:00.000Z").toISOString(),
		alertRule: {
			id: "rule-2",
	...
	},
	{
		...
		metadata: {},
		isManual: false,
		submissionDeadline: new Date("2024-12-03T00:00:00.000Z").toISOString(),
		isOverdue: false,
		fileGeneratedAt: new Date("2024-11-30T00:00:00.000Z").toISOString(),
		createdAt: new Date("2024-11-30T00:00:00.000Z").toISOString(),
		updatedAt: new Date("2024-11-30T00:00:00.000Z").toISOString(),
		alertRule: {
			id: "rule-3",
	...
	},
	{
		...
		metadata: {},
		isManual: false,
		submissionDeadline: new Date("2024-11-25T00:00:00.000Z").toISOString(),
		isOverdue: true,
	...
	},
	{
		...
		cancelledAt: new Date("2024-11-30T00:00:00.000Z").toISOString(),
		createdAt: new Date("2024-11-30T00:00:00.000Z").toISOString(),
		updatedAt: new Date("2024-11-30T00:00:00.000Z").toISOString(),
		alertRule: {
			id: "rule-5",
